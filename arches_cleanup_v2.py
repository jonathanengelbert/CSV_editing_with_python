...
#DESCRIPTION: This script cleans up csv files generated by a Arches Process. It generatese a new csv file mirroring all data, while extracting picture file names from field column "Information Carrier", and printing them separated by commas, enclosed in double quotes.
